...
export const compute_boltzmann_wabisabi: (a: number, b: number, c: number, d: number, e: bigint, f: number) => any;
...
export const prepare_boltzmann_ranged: (a: number, b: number, c: number, d: number, e: bigint, f: bigint, g: bigint, h: number, i: number, j: number) => any;
