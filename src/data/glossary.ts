...
export const GLOSSARY_ITEMS: GlossaryItem[] = [
  { id: "address-reuse", termKey: "glossary.term_address_reuse", defKey: "glossary.def_address_reuse" },
  { id: "bip47", termKey: "glossary.term_bip47", defKey: "glossary.def_bip47" },
  { id: "bisq", termKey: "glossary.term_bisq", defKey: "glossary.def_bisq" },
  { id: "bnb", termKey: "glossary.term_bnb", defKey: "glossary.def_bnb" },
  { id: "boltzmann-entropy", termKey: "glossary.term_boltzmann", defKey: "glossary.def_boltzmann" },
  { id: "chain-analysis", termKey: "glossary.term_chain_analysis", defKey: "glossary.def_chain_analysis" },
  { id: "change-output", termKey: "glossary.term_change_output", defKey: "glossary.def_change_output" },
  { id: "cpfp", termKey: "glossary.term_cpfp", defKey: "glossary.def_cpfp" },
  { id: "cioh", termKey: "glossary.term_cioh", defKey: "glossary.def_cioh" },
  { id: "coin-control", termKey: "glossary.term_coin_control", defKey: "glossary.def_coin_control" },
  { id: "coinjoin", termKey: "glossary.term_coinjoin", defKey: "glossary.def_coinjoin" },
  { id: "consolidation", termKey: "glossary.term_consolidation", defKey: "glossary.def_consolidation" },
  { id: "dust-attack", termKey: "glossary.term_dust_attack", defKey: "glossary.def_dust_attack" },
  { id: "hd-wallet", termKey: "glossary.term_hd_wallet", defKey: "glossary.def_hd_wallet" },
  { id: "heuristic", termKey: "glossary.term_heuristic", defKey: "glossary.def_heuristic" },
  { id: "hodlhodl", termKey: "glossary.term_hodlhodl", defKey: "glossary.def_hodlhodl" },
  { id: "joinmarket", termKey: "glossary.term_joinmarket", defKey: "glossary.def_joinmarket" },
  { id: "mempool", termKey: "glossary.term_mempool", defKey: "glossary.def_mempool" },
  { id: "multisig", termKey: "glossary.term_multisig", defKey: "glossary.def_multisig" },
  { id: "op-return", termKey: "glossary.term_op_return", defKey: "glossary.def_op_return" },
  { id: "payjoin", termKey: "glossary.term_payjoin", defKey: "glossary.def_payjoin" },
  { id: "payjoin-v2", termKey: "glossary.term_payjoin_v2", defKey: "glossary.def_payjoin_v2" },
  { id: "paynym", termKey: "glossary.term_paynym", defKey: "glossary.def_paynym" },
  { id: "peel-chain", termKey: "glossary.term_peel_chain", defKey: "glossary.def_peel_chain" },
  { id: "privacy-score", termKey: "glossary.term_privacy_score", defKey: "glossary.def_privacy_score" },
  { id: "round-amount", termKey: "glossary.term_round_amount", defKey: "glossary.def_round_amount" },
  { id: "script-type", termKey: "glossary.term_script_type", defKey: "glossary.def_script_type" },
  { id: "self-send", termKey: "glossary.term_self_send", defKey: "glossary.def_self_send" },
  { id: "silent-payments", termKey: "glossary.term_silent_payments", defKey: "glossary.def_silent_payments" },
  { id: "stonewall", termKey: "glossary.term_stonewall", defKey: "glossary.def_stonewall" },
  { id: "submarine-swap", termKey: "glossary.term_submarine_swap", defKey: "glossary.def_submarine_swap" },
  { id: "sweep", termKey: "glossary.term_sweep", defKey: "glossary.def_sweep" },
  { id: "taproot", termKey: "glossary.term_taproot", defKey: "glossary.def_taproot" },
  { id: "taproot-channels", termKey: "glossary.term_taproot_channels", defKey: "glossary.def_taproot_channels" },
  { id: "tor", termKey: "glossary.term_tor", defKey: "glossary.def_tor" },
  { id: "utxo", termKey: "glossary.term_utxo", defKey: "glossary.def_utxo" },
  { id: "wallet-fingerprint", termKey: "glossary.term_wallet_fingerprint", defKey: "glossary.def_wallet_fingerprint" },
  { id: "whirlpool", termKey: "glossary.term_whirlpool", defKey: "glossary.def_whirlpool" },
  { id: "wabisabi", termKey: "glossary.term_wabisabi", defKey: "glossary.def_wabisabi" },
];

/** Fallback English text keyed by i18n key. Used as defaultValue in t() calls. */
export const GLOSSARY_DEFAULTS: Record<string, string> = {
  ...
  "glossary.def_heuristic": "A rule-of-thumb used to infer information about a Bitcoin transaction. am-i.exposed applies 33 heuristics to estimate what surveillance firms can deduce about any transaction or address.",
  ...
  "glossary.def_privacy_score": "A 0-100 rating computed by am-i.exposed based on 33 heuristics. Starts at 70, adjusted by findings. Only CoinJoin, Taproot, and high entropy can raise it. Grades: A+ (90-100), B (75-89), C (50-74), D (25-49), F (0-24).",
