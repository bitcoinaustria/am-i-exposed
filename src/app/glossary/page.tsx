...
const GLOSSARY_ITEMS = [
  ...
  {
    id: "bnb",
    termKey: "glossary.term_bnb",
    defKey: "glossary.def_bnb",
  },
  {
  ...
  {
    id: "cpfp",
    termKey: "glossary.term_cpfp",
    defKey: "glossary.def_cpfp",
  },
  {
    id: "cioh",
  ...
  {
    id: "payjoin-v2",
    termKey: "glossary.term_payjoin_v2",
    defKey: "glossary.def_payjoin_v2",
  },
  {
    id: "paynym",
  ...
  {
    id: "silent-payments",
    termKey: "glossary.term_silent_payments",
    defKey: "glossary.def_silent_payments",
  },
  {
    id: "stonewall",
  ...
  {
    id: "submarine-swap",
    termKey: "glossary.term_submarine_swap",
    defKey: "glossary.def_submarine_swap",
  },
  {
    id: "sweep",
  ...
  {
    id: "taproot-channels",
    termKey: "glossary.term_taproot_channels",
    defKey: "glossary.def_taproot_channels",
  },
  {
    id: "tor",
...
const DEFAULTS: Record<string, string> = {
  ...
  "glossary.term_bnb": "Branch and Bound (BnB)",
  "glossary.def_bnb": "A coin selection algorithm that searches for UTXO combinations that exactly match the payment amount plus fee, eliminating the need for a change output. By producing changeless transactions, BnB defeats change detection heuristics entirely. Bitcoin Core uses BnB as its default coin selection strategy.",
  ...
  "glossary.term_silent_payments": "Silent Payments (BIP352)",
  "glossary.def_silent_payments": "A protocol that allows a recipient to publish a single static payment address from which senders derive unique, unlinkable Taproot (P2TR) outputs for each payment. Unlike BIP47, Silent Payments require no on-chain notification transaction. The recipient scans the blockchain using the sender's input public keys to detect payments. Supported by Bitcoin Core 28+, Cake Wallet, and Silentium.",
