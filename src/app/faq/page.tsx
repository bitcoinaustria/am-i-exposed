...
const DEFAULTS: Record<string, string> = {
  ...
  "faq.a_check_privacy": "Paste your Bitcoin address or transaction ID into am-i.exposed. The tool analyzes it using 17 heuristics - the same techniques chain analysis firms use - and gives you a privacy score from 0 to 100 with a letter grade (A+ to F) and specific actionable findings. Everything runs in your browser with no tracking.",
